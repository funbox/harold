const { getPlural } = require('@funboxteam/diamonds');
const Table = require('cli-table3');
const prettyBytes = require('pretty-bytes');

const c = require('../lib/colorize');

module.exports = function diffTotal({ left, right, leftCaption = 'Left', rightCaption = 'Right' } = {}) {
